...
### Install `DAAG`
Package `DAAG` has been archived, but you can still install it via the below script:
```{r echo = TRUE, eval = FALSE}
url <- "https://cran.r-project.org/src/contrib/Archive/DAAG/DAAG_1.22.1.tar.gz"
pkgFile <- "DAAG.1.22.1.tar.gz"
download.file(url = url, destfile = pkgFile)
devtools::install_version("latticeExtra", version = "0.6-28", dependencies = FALSE)
