...
- Part C: Supervised and unsupervised clustering
    - [Lecture C](Material/Part A/Lecture_A.html)
    - [Practical C](Material/Part A/Practical_A_walkthrough.html)
    - [Impractical C](Material/Part A/Practical_A.html)
...
- Part C: Model estimation
    - [Lecture C](Material/Part JK - Model estimation/Lecture_J.html)
    - [Practical C](Material/Part JK - Model estimation/Practical_J_walkthrough.html)
    - [Impractical C](Material/Part JK - Model estimation/Practical_J.html)
- Part D: Classification & Clustering
    - [Lecture D](Material/Part M - Unsupervised learning/Lecture_M.html)
    - [Practical D](Material/Part M - Unsupervised learning/Practical_M_walkthrough.html)
    - [Impractical D](Material/Part M - Unsupervised learning/Practical_M.html)
...
The above link is a useful reference that connects to today's materials.
